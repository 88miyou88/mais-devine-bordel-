...
Base technique actuelle : **0.9.5**

La V0.9.5 stable ajoute :
...
Cette archive constitue la version stable V0.9.5. Les autres bibliothèques révisées seront intégrées dans une mise à jour ultérieure.
...
`https://88miyou88.github.io/mais-devine-bordel-/?v=095`

Diagnostic attendu :

```text
Version : 0.9.5
Cache attendu : mdb-v0-9-5
```
