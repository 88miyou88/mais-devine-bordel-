...
async function loadMode(modeId, legacySettings) {
  ...
  const autoMigrateOfficialContent = shouldAutoMigrateLibrary(
    modeId,
    installedVersion,
  ...
  state.modes[modeId] = {
    ...
    libraryMeta: {
      ...
      deletedOfficialCardIds: autoMigrateOfficialContent
      ...
      deletedOfficialBoxIds: autoMigrateOfficialContent
