...
export async function buildDiagnostic() {
  ...
  return [
    ...
    `Après minuit : ${state.settings.modeOptions.drinking.adultMode ? "Oui" : "Non"}`,
    `Plafond Qui boit : ${state.settings.modeOptions.drinking.maxPenalty}`,
    `Alternative Team soft : ${state.settings.modeOptions.drinking.softPenaltyMode}`,
    `Joueurs Qui boit : ${state.settings.modeOptions.drinking.players.length}`,
    ...modeLines,
