...
export const el = {
  ...
  drinkingPenaltyText: document.querySelector("#drinkingPenaltyText"),
  ...
  drinkingSkipButton: document.querySelector("#drinkingSkipButton"),
  drinkingRulePenaltyButton: document.querySelector("#drinkingRulePenaltyButton"),
  drinkingLeftActionButton: document.querySelector("#drinkingLeftActionButton"),
  drinkingRightActionButton: document.querySelector("#drinkingRightActionButton"),
