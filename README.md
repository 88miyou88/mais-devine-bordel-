...
La V0.7.0 ajoute un véritable mode multijoueur local :
...
La V0.7.0 conserve les clés de stockage existantes et reste compatible avec les données V0.5.x et V0.6.0 :
...
`https://88miyou88.github.io/mais-devine-bordel/?v=070`
